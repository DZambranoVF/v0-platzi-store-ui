...
export const products: Product[] = [
  ...
  {
    id: '8.5',
    name: 'Camiseta Neon Platzi',
    slug: 'camiseta-neon-platzi',
    price: 89000,
    category: 'ropa',
    colors: ['Negro'],
    sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
    images: ['/images/camiseta-negra-2.jpg'],
    colorImages: {
      'Negro': '/images/camiseta-negra-2.jpg',
    },
    description: 'Camiseta premium Platzi con diseño neon "Nunca pares de aprender" y logo Platzi. 100% algodón con estampado de calidad superior.',
    materials: '100% algodón peinado premium, 180g/m²',
    care: 'Lavar a máquina en frío. No usar secadora. Planchar a temperatura media.',
    isNew: true,
    isFeatured: true,
