...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: 'accesorios',
    colors: ['Multicolor'],
    images: ['/products/stickers-1.jpg', '/products/stickers-2.jpg'],
  ...
  },
  {
    ...
    description: 'Mochila urbana de 25L con compartimento acolchado para laptop de hasta 15". Múltiples bolsillos y diseño ergonómico.',
    materials: 'Poliéster 600D resistente al agua con base reforzada',
    care: 'Limpiar con paño húmedo. No lavar a máquina.',
    isFeatured: true,
  },
  {
    ...
    price: 35000,
    category: 'ropa',
    colors: ['Negro', 'Verde', 'Rosa'],
    sizes: ['S/M', 'L/XL'],
    images: ['/products/calcetines-1.jpg', '/products/calcetines-2.jpg'],
